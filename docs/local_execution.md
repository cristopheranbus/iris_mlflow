...
conservan métricas, artefactos, tags, descripción y aliases `Challenger` y
`Champion`.

## Promoción simulada

Ejecuta los notebooks de `deployment/` en este orden: evaluación, aprobación,
despliegue y creación del job. Con `IRIS_LOCAL_AUTO_APPROVE=true`, la aprobación
